 ...
 * @author chathura
 */
public class UpdateInspector extends javax.swing.JFrame {

    /**
     * Creates new form UpdateInspector
     */
...
//
//            if (x == 1) {
                em.setRegId(Integer.parseInt(txtRegid.getText().toString()));
...
//                em.setConfirmPassword(txtconfirmPassword.getText());
                ...
                boolean result = dbops.updateInspector(em);
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateInspector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new UpdateInspector().setVisible(true);
            }
        });
    }
